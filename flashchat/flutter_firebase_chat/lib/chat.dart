    ...
    listScrollController.addListener(() {
      if (listScrollController.position.atEdge) {
        if (listScrollController.position.pixels == 0) {
          // you are at botton position because of reverse snapshot
          print('At Bottom');
        } else {
          isLazyLoad = true;
          // you are at top position because of reverse snapshot
          print('At Top');
          setState(() {
            messagesCount += 20;
          });
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      Firestore.instance.runTransaction((transaction) async {
        ...
        final audioCached = AudioCache();
        audioCached.play('drop.wav');
//        advancedPlayer.play('drop.wav');
        print('message sent');
      });
